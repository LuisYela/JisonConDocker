...
yy: {},
symbols_: {"error":2,"inicio":3,"instrucciones":4,"EOF":5,"instruccion":6,"Roperar":7,"tmenorq":8,"expresion":9,"tmayorq":10,"tpcoma":11,"tmenos":12,"tmas":13,"tpor":14,"tdiv":15,"tentero":16,"tdecimal":17,"tparA":18,"tparC":19,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",7:"Roperar",8:"tmenorq",10:"tmayorq",11:"tpcoma",12:"tmenos",13:"tmas",14:"tpor",15:"tdiv",16:"tentero",17:"tdecimal",18:"tparA",19:"tparC"},
...
case 5:
		...
		this.$='El valor de la expresion es: ' + $$[$0-2];
...
rules: [/^(?:operar\b)/i,/^(?:;)/i,/^(?:\()/i,/^(?:\))/i,/^(?:>)/i,/^(?:<)/i,/^(?:\+)/i,/^(?:-)/i,/^(?:\*)/i,/^(?:\/)/i,/^(?:[ \r\t]+)/i,/^(?:\n)/i,/^(?:[0-9]+\.[0-9]+)/i,/^(?:[0-9]+)/i,/^(?:$)/i,/^(?:.)/i],
